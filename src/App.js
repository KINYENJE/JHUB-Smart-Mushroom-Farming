...
function App() {
  return (
    <div className="w-full max-w-[1440px] px-8 lg:px-14 App min-h-[100vh] mt-10 overflow-x-hidden ">
      <h1 className='block text-3xl font-semibold sm:text-title-xl underline underline-offset-4 '>SMART MUSHROOM FARMING</h1>

      {/** Mushroom farming in kenya details */}
      <div className="w-full flex gap-5 mt-12">
        
        <div className="w-1/2 text-wrap flex items-center justify-center px-10 ">
        <p>
      ...
      <section className='my-16 w-full h-[100vh] '>
        ...
        <h2 className='text-xl capitalize my-8 underline underline-offset-3'>Variety of Mushrooms Grown In Kenya</h2>
