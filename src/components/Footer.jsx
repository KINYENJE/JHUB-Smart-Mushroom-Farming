...
const Footer = () => {
  return (
    <div className='w-full h-96 bg-black py-12 flex items-center justify-between relative text-white'>
      ...
      <div className='w-1/3 flex flex-col gap-8 items-center justify-center'> 
        <h1 className=' text-blue-600 text-left text-xl'>Connect with us at:</h1>
